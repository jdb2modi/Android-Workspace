...
public class MainActivity extends Activity implements OnClickListener {
	...
	private String strName, strLastName, strEmail, strPassword, strConPassword,
			strContact;
	private Button btnSubmit, btnUpdate, btnDelete, btnView, btnViewAll;
	...
	public void submitData() {
		mdb.insertData(edName.getText().toString(), edLastname.getText()
				.toString(), edEmail.getText().toString(), spinnerCity
				.getSelectedItem().toString(), edPassword.getText().toString(),
				edContact.getText().toString());
		Toast.makeText(getApplicationContext(), "One Raw Inserted",
				Toast.LENGTH_LONG).show();
		clearData();
	}

	public void updateData() {
		mdb.updateData(edName.getText().toString(), edLastname.getText()
				.toString(), edEmail.getText().toString(), spinnerCity
				.getSelectedItem().toString(), edPassword.getText().toString(),
				edContact.getText().toString());
	...
	public void deleteData() {
		mdb.deleteData(edEmail.getText().toString());
	...
	public void checkAndSendData() {
		...
		/*
		 * else { /* Intent intentSendData = new Intent(getApplicationContext(),
		 * UserDataActivity.class); intentSendData.putExtra("NAME",
		 * edName.getText().toString()); intentSendData .putExtra("LASTNAME",
		 * edLastname.getText().toString()); intentSendData.putExtra("EMAIL",
		 * edEmail.getText().toString()); intentSendData.putExtra("CONTACT",
		 * edContact.getText().toString()); // /To Fetch from selected Radio
		 * Button... final String value = ((RadioButton) findViewById(rgGender
		 * .getCheckedRadioButtonId())).getText().toString();
		 * intentSendData.putExtra("GENDER", value);
		 * intentSendData.putExtra("CITY", spinnerCity.getSelectedItem()
		 * .toString()); startActivity(intentSendData);
		 * 
		 * }
		 */
	}// End of sendData...
