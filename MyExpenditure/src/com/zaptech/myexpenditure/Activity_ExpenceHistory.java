...
public class Activity_ExpenceHistory extends Activity implements
		OnClickListener {
	...
	public void onClick(View v) {
		...
		case R.id.btn_showAllHistory:
			finish();
			intent = new Intent(Activity_ExpenceHistory.this,
					Activity_ViewExpenceHistory.class);
