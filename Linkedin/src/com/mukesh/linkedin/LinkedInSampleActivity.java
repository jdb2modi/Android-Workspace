	...
	public void onCreate(Bundle savedInstanceState) {
		...
		share.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				if (null != share && !share.equalsIgnoreCase("")) {
					...
					try {
						...
						Toast.makeText(LinkedInSampleActivity.this,
								"Shared sucessfully", Toast.LENGTH_SHORT)
								.show();
				...
				/*
				 * String share = et.getText().toString(); if (null != share &&
				 * !share.equalsIgnoreCase("")) { client =
				 * factory.createLinkedInApiClient(accessToken);
				 * client.postNetworkUpdate(share); et.setText("");
				 * Toast.makeText(LinkedInSampleActivity.this,
				 * "Shared sucessfully", Toast.LENGTH_SHORT).show(); } else {
				 * Toast.makeText(LinkedInSampleActivity.this,
				 * "Please enter the text to share", Toast.LENGTH_SHORT).show();
				 * }
				 */
			}
		});
				...
				try {
					...
					if (p != null) {
						...
						if (url != null && !url.isEmpty()) {
							Picasso.with(LinkedInSampleActivity.this).load(url)
									.into(photo);
